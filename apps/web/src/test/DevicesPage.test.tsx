...
describe('Portal devices UI', () => {
  ...
  it('shows linked inspections on device details', async () => {
    mockApi([], [{
      id: 'inspection-id',
    ...
    expect(screen.getByText('Po terminie')).toBeVisible();
  });
...
function mockApi(repairs: unknown[] = [], inspections: unknown[] = []) {
  vi.stubGlobal(
    'fetch',
